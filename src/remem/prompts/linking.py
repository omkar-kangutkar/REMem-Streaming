def get_query_instruction(linking_method):
    instructions = {
        ...
        "query_to_triple": "Given a question, retrieve relevant triplet facts that matches this question.",
        ...
        "query_to_message": "Given a question, retrieve relevant messages that best answer the question.",
    }
